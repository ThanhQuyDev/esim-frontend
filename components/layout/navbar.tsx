  ...
  return {
      ...
      explore: [
        {
          title: isVi ? "Tính năng bảo mật" : "Security features",
          desc: isVi
            ? "Khám phá tính năng bảo vệ kỹ thuật số của Saily."
            : "Discover Saily's built-in digital protection.",
          href: "#",
          image:
            "https://sb.nordcdn.com/m/7bf573d226cb4b2d/original/mega-menu-explore-security-features.png",
          imageAlt: "A man uses Saily's built-in digital protection.",
        },
        {
          title: isVi ? "eSIM cho Doanh nghiệp" : "eSIM for Business",
          desc: isVi
          ...
          imageAlt:
            "A smiling woman using her phone, which mirrors the Saily business dashboard.",
        },
        {
          title: "Ultra Plan",
          desc: isVi
          ...
          imageAlt: "The Ultra plan tab on the Saily app.",
        },
      ],
      bottomLeft: {
        icon: true,
    ...
    resources: {
      ...
      col2: [
        ...
        {
          icon: "message-dots",
          title: isVi ? "Đánh giá Saily" : "Saily Reviews",
          desc: isVi
    ...
    offers: {
      col1: [
        {
          ...
          desc: isVi
            ? "Chia sẻ Saily với bạn bè và nhận thưởng."
            : "Share Saily with friends and earn rewards.",
          href: "#",
        },
        {
          icon: "badge-percent",
        ...
        {
          icon: "tag",
          title: isVi ? "Mã giảm giá Saily" : "Saily Coupons",
          desc: isVi
      ...
      col2: [
        {
          icon: "ticket",
          title: isVi ? "Voucher Saily" : "Saily vouchers",
          desc: isVi
            ? "Nhận voucher Saily, sử dụng trong 12 tháng."
            : "Get a Saily voucher, use within 12 months.",
          href: "#",
        },
      ],
      explore: [
      ...
      col1: [
        {
          ...
          desc: isVi
            ? "Hướng dẫn nhanh sử dụng ứng dụng Saily eSIM."
            : "A quick guide to using the Saily eSIM app.",
          href: "#",
        },
        {
          icon: "globe",
      ...
      col2: [
        {
          ...
          title: "FAQ",
          desc: isVi
            ? "Tìm câu trả lời cho các câu hỏi phổ biến nhất về Saily."
            : "Find answers to the most common questions about Saily.",
          href: "#",
        },
      ],
      explore: [
          ...
          >
            ...
            <div className="pr-12">
              <Link href={`/${lang}`} className="block">
                <SailyLogo />
                <span className="sr-only">Saily</span>
              </Link>
            </div>
