                ...
                >
                    ...
                    {navLinks.map((link) => (
                        <Link
                            key={link.href}
                            href={link.href}
                            className="w-full text-left px-4 py-3 xl:w-auto xl:px-3 xl:py-2 text-[0.94rem] xl:text-base font-medium text-gray-900 hover:text-blue-600 hover:bg-gray-50 xl:hover:text-blue-600 xl:hover:bg-transparent border-b xl:border-b-0 border-gray-200 transition-colors"
                        >
                            {link.label}
                        </Link>
                    ))}
