        ...
        >
            ...
            >
                ...
                <button
                    ...
                    className="ml-2 inline-flex items-center justify-center w-10 h-10 rounded-md text-gray-700 hover:bg-gray-100 transition-colors xl:hidden"
                ...
                <div
                    ...
                    className={cn(
                        ...
                        "max-xl:absolute max-xl:left-0 max-xl:right-0 max-xl:top-full max-xl:bg-white max-xl:border-b max-xl:border-gray-200 max-xl:shadow-md max-xl:p-4 max-xl:flex-col max-xl:items-stretch max-xl:gap-3 max-xl:transition-opacity max-xl:duration-150",
                ...
                >
                    ...
                    <div className="relative inline-flex items-center px-2 py-1 rounded-md border border-gray-300 bg-white hover:border-gray-400 transition-colors">
                        <Globe
                            ...
                            aria-hidden="true"
                        />
                        <span className="text-sm font-medium uppercase text-gray-700 min-w-5">
                            {lang}
                        </span>
                        <ChevronDown
