            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 pl-10 pr-4 py-3 text-base sm:text-sm outline-none transition-colors focus:border-[var(--bg-accent)] focus:ring-1 focus:ring-[var(--bg-accent)]"
                />
              </div>
            </div>
