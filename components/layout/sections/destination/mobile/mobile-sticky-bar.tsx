    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex-1 min-w-0 h-[42px] px-3 rounded-[30px] border-[1.5px] border-[#D1B700] bg-[#FFF500] text-[13.5px] font-bold cursor-pointer text-[#1a1a1a] transition-colors active:bg-[#D1B700] truncate"
        >
          {dict.buyNow}
        </button>
      </div>
