 ...
 * Displays plans as selectable chips with data + duration info.
 */
          ...
          return (
            ...
            >
              ...
              {plan.discount != null && plan.discount > 0 && (
                <span className="text-[9px] font-bold tracking-wide px-[5px] py-[2px] rounded leading-tight shrink-0 bg-[#dcfce7] text-[#166534]">
