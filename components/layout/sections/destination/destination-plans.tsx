  ...
  return (
    <div className="bg-white max-w-[100vw]">
      ...
      <div className="hidden min-[841px]:block">
        <div className="max-w-[1168px] mx-auto pb-[60px] grid grid-cols-[465px_minmax(0,1fr)] gap-8 items-start max-[1100px]:grid-cols-2 max-[1100px]:px-5 max-[1100px]:gap-6">
