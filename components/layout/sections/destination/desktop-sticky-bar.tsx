      ...
      <div className="max-w-[1168px] mx-auto px-6 py-3 flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3 min-w-0 flex-1">
          ...
          <div className="min-w-0">
            ...
            <div className="text-base font-medium text-[#1a1a1a] whitespace-nowrap overflow-hidden text-ellipsis">
              {planLabel}
            </div>
          </div>
        </div>
        ...
        {/* Center: Price */}
        <div className="text-2xl font-extrabold text-[#1a1a1a] whitespace-nowrap shrink-0">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="flex items-center border-[1.5px] border-[#e5e7eb] rounded-[30px] h-[40px]">
            ...
            <span className="text-base font-medium min-w-[20px] text-center px-1">{quantity}</span>
            <button
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-5 h-[40px] rounded-[30px] border-[1.5px] border-[#1a1a1a] bg-white text-base font-semibold cursor-pointer text-[#1a1a1a] transition-all hover:bg-[#1a1a1a] hover:text-white"
          >
          ...
          <button
            onClick={handleAddToCart}
            className="flex items-center justify-center px-6 h-[40px] rounded-[30px] border-[1.5px] border-[#D1B700] bg-[#FFF500] text-base font-medium cursor-pointer text-[#1a1a1a] transition-all hover:bg-[#D1B700]"
          >
            {dict.buyNow}
          </button>
        </div>
