    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="glass-card p-10 md:p-16 lg:p-20 text-center max-w-4xl mx-auto relative overflow-hidden">
          ...
          <h2 className="font-display font-bold text-3xl md:text-4xl lg:text-5xl text-white mb-5 tracking-tight relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative">
            <Button asChild size="lg" className="gradient-bg-green text-white font-semibold rounded-full px-8 h-13 text-base hover:opacity-90 transition-all duration-300 hover:shadow-[0_0_32px_hsla(160,84%,44%,0.35)]">
              <Link href="#pricing">
                {dict.ctaPrimary}
                <ArrowRight className="ml-2 w-5 h-5" />
              </Link>
            </Button>
            <Button variant="outline" size="lg" className="rounded-full px-8 h-13 text-base border-white/[0.1] bg-white/[0.03] text-white hover:bg-white/[0.08] hover:text-white hover:border-white/[0.18] transition-all duration-300">
          ...
          <div className="flex items-center justify-center gap-6 mt-10 pt-8 border-t border-white/[0.06]">
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <span className="text-sm">{dict.trustRating}</span>
            </div>
            <div className="w-px h-4 bg-white/[0.08]" />
            <span className="text-sm text-muted-foreground">{dict.trustBrand}</span>
          </div>
        </div>
      </div>
    </section>
