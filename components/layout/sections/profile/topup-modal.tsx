        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          {packagesLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-base text-gray-500">{t.topupNoPackages}</p>
            </div>
          ) : (
            <>
              <p className="text-base text-gray-500 mb-4">{t.topupSubtitle}</p>
          ...
          <div className="border-t border-gray-100 bg-gray-50/80 px-5 py-3 space-y-2.5">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={onClose}
                disabled={isCheckingOut}
                className="px-4 py-2.5 rounded-xl text-base font-medium text-gray-600 hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {t.topupCancel}
              </button>
              <button
                ...
                disabled={!canConfirm}
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-base font-semibold bg-blue-600 text-white hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isCheckingOut ? (
                  <>
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-base text-gray-700 leading-snug">{pkg.name}</p>
          {!pkg.vndPrice && (
        ...
        <div className="flex flex-col items-end gap-1.5 shrink-0">
          <span className="text-xl font-medium text-gray-900">{priceLabel}</span>
          <span
