      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-0.5">
            <p className="text-base font-semibold text-gray-900 truncate font-mono">
              {esim.plan?.name}
            </p>
        ...
        <div className="border-t border-gray-100">
          ...
          <div className="flex border-b border-gray-100">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 px-4 py-2.5 text-base font-medium transition-colors ${activeTab === "info"
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 px-4 py-2.5 text-base font-medium transition-colors ${activeTab === "dataUsage"
                  ? "text-blue-600 border-b-2 border-blue-600 bg-blue-50/30"
                  : "text-gray-500 hover:text-gray-700 hover:bg-gray-50"
                }`}
            >
                ...
                <div className="space-y-3">
                  {fields.map(({ label, value, copyable }) => (
                    <div key={label}>
                      ...
                      <div className="flex items-center gap-1 bg-gray-50 rounded-lg px-3 py-2">
                        <p className="text-base text-gray-900 font-mono break-all flex-1">
                          {value || "—"}
                        </p>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <div className="bg-gray-50 rounded-lg px-3 py-2">
                          <p className="text-base text-gray-900">{planTypeLabel}</p>
                        </div>
                      </div>
                      <div>
                        <p className="text-[13px] font-medium text-gray-400 uppercase tracking-wider mb-1">
                      ...
                      <div>
                        ...
                        <div className="bg-gray-50 rounded-lg px-3 py-2">
                          {activationDeadline ? (
                            <p className={`text-base ${activationDaysLeft !== null && activationDaysLeft <= 30 ? "text-amber-600 font-medium" : "text-gray-900"}`}>
                  ...
                  {esim.directAppleInstallationUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-gray-900 text-white rounded-lg text-base font-medium hover:bg-gray-800 transition-colors"
                    >
                  ...
                  {/* {canTopup && (
                    <button
                      ...
                      className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-blue-600 text-white rounded-lg text-base font-semibold hover:bg-blue-700 transition-colors shadow-sm"
                    >
    ...
    <div>
      {esims.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 text-base">{t.noEsims}</p>
        </div>
      ) : (
        <div className="space-y-3">
          {esims.map((esim) => (
