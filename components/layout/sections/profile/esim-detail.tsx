    ...
    <div className="mt-3 rounded-xl border border-blue-200 bg-blue-50/30 overflow-hidden animate-in slide-in-from-top-2 duration-300">
      ...
      <div className="flex border-b border-blue-200 bg-white">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 text-base font-medium transition-colors ${
            activeTab === "info"
              ...
              {infoFields.map(({ label, value, key }) => (
                <div key={key} className="bg-white rounded-lg border border-gray-200 p-3">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <code className="text-base text-gray-900 font-mono break-all flex-1">{value}</code>
                    <button
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
                <p className="text-[1.7rem] font-medium text-blue-600">
                  {esim.dataMb >= 1024
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
                <p className="text-[1.7rem] font-medium text-emerald-600">
