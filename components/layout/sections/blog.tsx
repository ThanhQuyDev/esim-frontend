    ...
    <section id="blog" className="relative gradient-bg-section-alt py-24 md:py-32">
      ...
      <div className="container">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14 md:mb-16">
          ...
          <Link href="#" className="inline-flex items-center gap-2 text-base text-primary hover:text-primary/80 transition-colors font-medium group">
            {dict.viewAll}
          ...
          {blogs.map((post, index) => (
            <article key={post.id} className="group glass-card-hover overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                {post.excerpt && (
                  <p className="text-base text-muted-foreground leading-relaxed line-clamp-3 mb-4 flex-1">{post.excerpt}</p>
                )}
                <Link href="#" className="inline-flex items-center gap-1.5 text-base text-primary font-medium hover:text-primary/80 transition-colors mt-auto group/link">
                  {dict.readMore}
