    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 space-y-4">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-border-primary">
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            />
            <span className="text-base sm:text-sm font-medium text-text-primary">
          ...
          {selectedIds.size > 0 && (
            <button
              ...
              className="inline-flex items-center gap-1.5 text-base sm:text-sm text-red-600 hover:text-red-700 font-medium transition-colors"
            >
      ...
      <div className="lg:col-span-1">
        <div className="sticky top-24 rounded-2xl border border-border-primary bg-white p-6 space-y-5">
          ...
          {/* Selected count */}
          <div className="text-base sm:text-sm text-text-secondary">
              ...
              <>
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-xl border border-border-primary px-4 py-2.5 text-base sm:text-sm outline-none focus:border-[var(--border-focus)] transition-colors"
                  />
                  <button
                    onClick={handleApplyPromo}
                    disabled={!promoInput.trim()}
                    className="rounded-xl bg-bg-brand-black px-4 py-2.5 text-base sm:text-sm font-medium text-white transition-colors hover:opacity-90 disabled:opacity-50 cursor-pointer"
                  >
                    {dict.apply || "Apply"}
                  </button>
                </div>
          ...
          {!user ? (
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-full bg-gray-100 py-3.5 text-xl sm:text-base font-semibold text-gray-500 transition-colors hover:bg-gray-200 cursor-pointer"
            >
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h4 className="text-base sm:text-sm font-semibold text-text-primary truncate">{item.name}</h4>
      ...
      <div className="flex flex-col items-end gap-3 flex-shrink-0">
        ...
        <div className="flex items-center gap-1 rounded-xl border border-border-primary">
          ...
          <span className="w-8 text-center text-base sm:text-sm font-medium text-text-primary">
            {item.quantity}
          </span>
          <button
            onClick={() => onQuantityChange(item.quantity + 1)}
