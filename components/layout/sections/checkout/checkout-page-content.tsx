  ...
  if (orderComplete) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-6">
        ...
        <h2 className="text-[1.7rem] sm:text-2xl font-medium text-text-primary">
  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-6">
        ...
        <h2 className="text-2xl sm:text-xl font-semibold text-text-primary">
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <Link
          href={localizedHref(lang, "cart")}
          className="inline-flex items-center gap-2 text-base sm:text-sm text-text-secondary hover:text-text-primary transition-colors"
        >
          <ArrowLeft className="h-4 w-4" />
          {dict.backToCart || "Back to Cart"}
        </Link>
        ...
        <div className="rounded-2xl border border-border-primary bg-white p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="email" className="text-base sm:text-sm font-medium text-text-primary">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border pl-10 pr-4 py-2.5 text-base sm:text-sm outline-none transition-colors ${errors.email ? "border-red-400" : "border-border-primary focus:border-[var(--border-focus)]"
                    }`}
                />
              </div>
            ...
            {/* Phone */}
            <div className="space-y-1.5">
              <label htmlFor="phone" className="text-base sm:text-sm font-medium text-text-primary">
                {dict.phone || "Phone"}
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border pl-10 pr-4 py-2.5 text-base sm:text-sm outline-none transition-colors ${errors.phone ? "border-red-400" : "border-border-primary focus:border-[var(--border-focus)]"
                    }`}
                />
              </div>
          ...
          <div className="rounded-2xl border border-border-primary bg-white p-6 space-y-4">
            ...
            {useExu && (
              <div className="space-y-2">
                <label className="text-base sm:text-sm font-medium text-text-primary">{wt.enterExuAmount}</label>
                <div className="relative">
                  <input
                    type="text"
                    value={exuAmount}
        ...
        <div className="rounded-2xl border border-border-primary bg-white p-6 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <span className="text-base sm:text-sm text-text-secondary">
          ...
          {wantInvoice && (
            <>
              <button
                ...
                className="flex items-center gap-2 text-base sm:text-sm text-blue-600 hover:text-blue-700 cursor-pointer"
              >
                {showInvoiceForm ? (
              ...
              {showInvoiceForm && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                  {/* Company Name */}
                  <div className="space-y-1.5">
                    <label htmlFor="companyName" className="text-base sm:text-sm font-medium text-text-primary">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border px-4 py-2.5 text-base sm:text-sm outline-none transition-colors ${errors.companyName ? "border-red-400" : "border-border-primary focus:border-[var(--border-focus)]"
                        }`}
                    />
                  ...
                  {/* Tax Code */}
                  <div className="space-y-1.5">
                    <label htmlFor="taxCode" className="text-base sm:text-sm font-medium text-text-primary">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border px-4 py-2.5 text-base sm:text-sm outline-none transition-colors ${errors.taxCode ? "border-red-400" : "border-border-primary focus:border-[var(--border-focus)]"
                        }`}
                    />
                  ...
                  <div className="space-y-1.5 sm:col-span-2">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border px-4 py-2.5 text-base sm:text-sm outline-none transition-colors ${errors.invoiceAddress ? "border-red-400" : "border-border-primary focus:border-[var(--border-focus)]"
                        }`}
                    />
        ...
        <div className="sticky top-24 rounded-2xl border border-border-primary bg-white p-6 space-y-5">
          ...
          <div className="space-y-3 max-h-60 overflow-y-auto">
            {items.map((item) => {
              ...
              return (
                <div key={item.id} className="flex justify-between text-base sm:text-sm">
