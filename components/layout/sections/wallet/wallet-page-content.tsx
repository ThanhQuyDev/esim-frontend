  ...
  if (error) {
    return (
      <div className="text-center py-20">
        ...
        <button
          onClick={() => refetch()}
          className="px-6 py-2 bg-gray-900 text-white rounded-full text-base sm:text-sm font-medium hover:bg-gray-800"
        >
          {t.retry}
        </button>
      </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        ...
        {isLocked && (
          <div className="mx-6 mb-4 flex items-start gap-3 rounded-xl bg-red-50 border border-red-100 p-4">
            ...
            <div>
              <p className="text-base sm:text-sm font-medium text-red-700">{t.walletLocked}</p>
        ...
        <div className="px-6 pb-4 flex gap-3">
          <Link
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-base sm:text-sm font-medium transition-colors ${
              isLocked
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-base sm:text-sm font-medium bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors"
          >
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        ...
        {txLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 text-base sm:text-sm">{t.errorLoading}</p>
          </div>
        ) : !transactions || transactions.length === 0 ? (
          <div className="text-center py-12">
            <Coins className="w-10 h-10 text-gray-300 mx-auto mb-3" />
            <p className="text-gray-400 text-base sm:text-sm">{t.noTransactions}</p>
          </div>
        ) : (
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 text-white">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-base sm:text-sm font-medium opacity-90">{t.referralTitle}</span>
          </div>
        ...
        {!referral.isActive && (
          <div className="mx-6 mt-4 flex items-start gap-3 rounded-xl bg-amber-50 border border-amber-100 p-4">
            ...
            <p className="text-base sm:text-sm text-amber-700">{t.referralInactive}</p>
          </div>
        )}
        ...
        <div className="p-6 space-y-4">
          ...
          {editSuccess && (
            <div className="flex items-center gap-2 rounded-xl bg-emerald-50 border border-emerald-100 p-3">
              ...
              <p className="text-base sm:text-sm text-emerald-700">{t.editReferralSuccess}</p>
            </div>
          )}
          ...
          {!isEditing ? (
            <div className="flex items-center gap-3">
              <div className="flex-1 bg-gray-50 rounded-xl px-4 py-3 border border-gray-100">
                ...
                <p className="text-base sm:text-sm font-mono font-medium text-gray-900">{referral.code}</p>
              </div>
              <button
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2.5 bg-gray-100 text-gray-700 rounded-xl text-base sm:text-sm font-medium hover:bg-gray-200 transition-colors flex-shrink-0"
            ...
            <div className="space-y-3">
              <div>
                <p className="text-base sm:text-sm font-medium text-gray-700 mb-1">{t.editReferralCode}</p>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  maxLength={10}
                  className={`flex-1 rounded-xl border px-4 py-2.5 text-base sm:text-sm font-mono outline-none transition-colors ${
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2.5 bg-blue-600 text-white rounded-xl text-base sm:text-sm font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 flex-shrink-0"
                >
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 bg-gray-50 rounded-xl px-4 py-3 border border-gray-100">
              ...
              <p className="text-base sm:text-sm text-gray-600 truncate">{referralLink}</p>
            </div>
            <button
              onClick={() => copyToClipboard(referralLink, "link")}
              className="flex items-center gap-1.5 px-4 py-2.5 bg-gray-100 text-gray-700 rounded-xl text-base sm:text-sm font-medium hover:bg-gray-200 transition-colors flex-shrink-0"
            >
              {copied === "link" ? (
                t.copied
              ) : (
          ...
          <div>
            ...
            <div className="flex gap-2">
              <a
                ...
                className="flex items-center gap-1.5 px-4 py-2 bg-[#1877F2] text-white rounded-xl text-base sm:text-sm font-medium hover:opacity-90 transition-opacity"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 px-4 py-2 bg-[#0068FF] text-white rounded-xl text-base sm:text-sm font-medium hover:opacity-90 transition-opacity"
              >
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100">
          ...
          <p className="text-base sm:text-sm text-gray-500 mt-1">{t.howItWorksDesc}</p>
        </div>
        <div className="p-6 space-y-6">
          {[
            ...
            <div key={item.step} className="flex gap-4">
              ...
              <div>
                <p className="text-base sm:text-sm font-semibold text-gray-900">{item.title}</p>
                <p className="text-base sm:text-sm text-gray-500 mt-0.5">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>
