...
export const walletTranslations: Record<"en" | "vi", WalletDict> = {
  en: {
    pageTitle: "eXU Points",
    tabWallet: "Wallet",
    tabReferral: "Referral",
    balanceTitle: "eXU Points",
    ...
    walletLockedDesc: "Your eXU points are currently locked. Please contact support for assistance.",
    useExu: "Use eXU",
    ...
    signInPrompt: "Please sign in to view your eXU points.",
    goHome: "Go Home",
    txOrderCashback: "eXU points earned from order",
    ...
    txRefundToWallet: "eXU points returned",
    ...
    howStep3Desc: "You receive {reward} after their order is paid successfully.",
    useExuBalance: "Use eXU points",
    useExuBalanceDesc: "Redeem eXU points against this order (1 point = 1 VND off).",
    enterExuAmount: "eXU points to use",
    exuBalance: "eXU points",
    referralCodeInput: "Referral Code",
    referralCodePlaceholder: "Enter referral code",
    applyReferral: "Apply",
    referralDiscount: "Referral Discount",
    exuSpent: "eXU points redeemed",
    ...
    exuInsufficient: "Not enough eXU points.",
    exuEarned: "eXU points earned",
    exuCashback: "You earned eXU points from this order!",
  ...
  vi: {
    ...
    walletLockedDesc: "Điểm eXU của bạn đang bị khóa. Vui lòng liên hệ hỗ trợ để được giúp đỡ.",
    useExu: "Dùng eXU",
    ...
    signInPrompt: "Vui lòng đăng nhập để xem điểm eXU của bạn.",
    goHome: "Về trang chủ",
    txOrderCashback: "Tích điểm eXU từ đơn hàng",
    ...
    txRefundToWallet: "Hoàn điểm eXU",
    ...
    howStep3Desc: "Bạn nhận {reward} sau khi đơn hàng của họ được thanh toán thành công.",
    useExuBalance: "Dùng điểm eXU",
    useExuBalanceDesc: "Dùng điểm eXU để trừ vào giá trị đơn hàng (1 điểm được trừ 1₫).",
    enterExuAmount: "Số điểm eXU muốn dùng",
    exuBalance: "Điểm eXU",
    ...
    exuInsufficient: "Không đủ điểm eXU.",
    exuEarned: "Điểm eXU được tích",
    exuCashback: "Bạn đã được tích điểm eXU từ đơn hàng này!",
    viewWallet: "Xem ví",
  },
};
