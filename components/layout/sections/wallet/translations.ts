...
export const walletTranslations: Record<"en" | "vi", WalletDict> = {
  en: {
    ...
    howStep3Desc: "You receive {reward} in eXU after their order is paid successfully.",
  ...
  vi: {
    ...
    howStep3Desc: "Bạn nhận {reward} eXU sau khi đơn hàng của họ được thanh toán thành công.",
