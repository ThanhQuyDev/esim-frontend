...
export function ArticleToc({ headings: headingsProp, content, lang = "en" }: ArticleTocProps) {
  ...
  return (
    ...
    >
      <div className="text-xl sm:text-base font-semibold text-gray-900 mb-4">{tocTitle}</div>
          ...
          return (
            <li key={h.id} className="leading-snug">
              <a
                ...
                className={`block -ml-px pl-3 py-1 text-base sm:text-sm border-l-2 transition-colors no-underline ${isActive
      ...
      {hiddenHeadings.length > 0 && (
        <button
          ...
          className="mt-3 inline-flex items-center gap-1 pl-3 text-base sm:text-sm font-medium text-gray-700 hover:text-gray-900 cursor-pointer bg-transparent border-0"
        >
