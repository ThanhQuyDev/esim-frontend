    ...
    return (
      <main role="main" className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-[1386px] mx-auto px-8 py-3">
            <form role="search" className="relative max-w-lg" onSubmit={(e) => e.preventDefault()}>
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-full text-base border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent"
                value={searchQuery}
              ...
              {searchQuery.trim() && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white rounded-lg shadow-xl border border-gray-200 max-h-64 overflow-y-auto z-50">
                  {isSearching ? (
                    <div className="p-3 text-center text-gray-500 text-base">
          ...
          <div className="max-w-[1386px] mx-auto px-8">
            <div className="flex items-center pt-4 pb-4">
              <nav aria-label="Breadcrumb">
                <ol className="flex items-center gap-1 list-none p-0 m-0 text-base">
                  <li>
        ...
        <div className="max-w-[1386px] mx-auto px-8 py-8">
          <article>
            <h1 className="text-[1.7rem] font-medium mb-4">{selectedArticle.title}</h1>
            <div
