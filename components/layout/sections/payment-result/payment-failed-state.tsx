  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 py-20 bg-gray-50">
      <div className="max-w-md w-full rounded-2xl border border-gray-200 bg-white p-8 md:p-10 text-center shadow-sm">
        ...
        <h1 className="font-medium text-[1.7rem] sm:text-2xl md:text-3xl text-gray-900 mb-2">
          {config.label[lang]}
        </h1>
          ...
          <div className="space-y-3 mb-8 text-left">
            {orderId && (
              <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                ...
                <span className="text-base sm:text-sm font-medium text-gray-900 font-mono">{orderId}</span>
              </div>
            )}
            {transactionNo && (
              <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                ...
                <span className="text-base sm:text-sm font-medium text-gray-900 font-mono">{transactionNo}</span>
              </div>
            )}
            {amount > 0 && (
              <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
        ...
        {!isValid && (
          <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
            <p className="text-base sm:text-sm text-red-700">
              {lang === "vi"
