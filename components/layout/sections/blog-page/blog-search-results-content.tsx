            ...
            <div className="container mx-auto">
              ...
              >
                ...
                <input
                  ...
                  className="w-full pl-12 pr-28 py-3 rounded-full text-xl sm:text-base border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  aria-label={lang === "vi" ? "Tìm kiếm blog" : "Search blog"}
                />
                <button
                  type="submit"
                  className="absolute right-2 top-1/2 -translate-y-1/2 px-5 py-2 bg-brand-black text-white text-base sm:text-sm font-medium rounded-full hover:opacity-80 transition-opacity"
                >
